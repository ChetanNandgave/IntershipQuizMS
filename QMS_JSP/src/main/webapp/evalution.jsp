...
<body bgcolor="${initParam.theme}">
	...
	<div class="mainBody">
		...
		<jsp:useBean id="eval" class="com.swappy.quiz.beans.EvaluateBean"
			scope="request" />
		<%
		...
		com.swappy.quiz.beans.QuestionList qlb = (com.swappy.quiz.beans.QuestionList) session.getAttribute("qlb");
		eval.setCorrectAnswer(qlb.getQuestionlist());

		eval.setQuizid(Integer.parseInt(request.getParameter("quizid")));
		eval.setStudentid(((com.swappy.quiz.beans.LoginBean) session.getAttribute("lb")).getUser().getId());
